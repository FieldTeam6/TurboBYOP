...
const enabledSites = [
    ...
    {
        regex: /https\:\/\/(www\.)?textnow\.com\/messaging/i,
        origin: 'https://www.textnow.com/messaging',
        name: 'TextNow'
    }
];
...
async function onOpen() {
    ...
    if (
        ...
        (textPlatform === 'text-now' && !currentTab.url.startsWith('https://www.textnow.com/messaging')) ||
        (textPlatform !== 'text-free' && textPlatform !== 'text-now')
    ) {
