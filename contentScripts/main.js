...
const selectors = {
    ...
    gvSendButtonNew: 'gv-icon-button-ng2[gv-test-id="send_message"] button, gv-icon-button-ng2[icon-name="send"][label="Send message"] button, button[aria-label="Send message"]',
